...
#  #
#  #  STRUKTŪRA:
#  #  1. Kodo supratimo klausimai #  2. Mažos programavimo užduotys
...
#  # ATSAKYMAS: kad neuzkaitytu vieno atsakymo kaip abieju
...
#  # ATSAKYMAS:  kad i reiksme keistusi
...
#  # ATSAKYMAS: reikes kad ivestum pasworda ir ji patikrins jei neteisngai parasys false
...
# Ką atspausdins programa? 2
# Paaiškinimas, kodėl taip gaunasi (2–3 sakiniai): % zenklas reiskia dalyba su liekanom pvz: 5%2= parasys 1 nes 5/2 =2 ir liekana 1. Tai 50 / 3 = 16 ir liekana 2 tai atspauzdins2
...
#     count = 0
#     for item in lst:
#         # TODO: Pridėti trūkstamas eilutes
#         pass
#     return count
#     print(count)
